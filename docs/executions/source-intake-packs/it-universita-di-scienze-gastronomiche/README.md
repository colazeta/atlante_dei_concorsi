# Intake pack — Università di Scienze Gastronomiche

Questo pacchetto documenta l'intake manuale delle fonti ufficiali per `it-universita-di-scienze-gastronomiche`.
